...
export default function Sixth() {
    return (
        <section className="w-full bg-[#F6F0E3] px-[152px] py-[48px]">
            <div className="grid grid-cols-2 gap-[24px] bg-white p-[12px]">
                ...
                <div className="relative overflow-hidden rounded-[16px]">
                    ...
                    <div className="absolute bottom-14 z-10 flex h-full max-w-[260px] flex-col justify-center gap-[14px] px-[32px]">
                        <h2 className="text-[22px] font-extrabold leading-[1.25] text-[#1F2937]">
                            Cook something
                            <br />
                            great tonight
