...
export default function OccasionProductDetailPage({ params }) {
  ...
  const occasionLabel = OCCASION_LABELS[product.occasion] ?? "Products";
  ...
  return (
    <div className="w-full bg-[#F6F0E3] px-[120px] py-[24px]">
      ...
      <div className="flex items-center gap-2 text-[13px] text-gray-500">
        ...
        <Link href="/groceries" className="hover:text-gray-700">Shop by occasion</Link>
        <ChevronRight className="h-[14px] w-[14px]" />
        <Link href={`/occasions/${product.occasion}`} className="hover:text-gray-700">{occasionLabel}</Link>
        <ChevronRight className="h-[14px] w-[14px]" />
